...
routes.post("/admin/recipes",multer.array("photos", 6), receitas.post); // Cadastrar nova receita
routes.put("/admin/recipes/:index", multer.array("photos", 6),receitas.put); // Editar uma receita
